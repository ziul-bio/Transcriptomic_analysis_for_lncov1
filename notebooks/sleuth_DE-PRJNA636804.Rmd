...
```{r}
base_dir <- "../results/PRJNA636804/kallisto/quant"
...
```{r}
#library(writexl)
#write_xlsx(sleuth_results_Q, path='../results/PRJNA636804/sleuth/results_sleuth_W_x_Q_Lago_et.al.xlsx')
```
...
ggsave(file="../results/PRJNA636804/figures/boxplot_ovaries_and_testis_lncov1_elf1a.jpeg", height=8, width=9, dpi=600)
```
