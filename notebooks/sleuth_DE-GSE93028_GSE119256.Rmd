...
```{r}
base_dir <- "../results/GSE93028/kallisto/quant"
...
#write_xlsx(sleuth_results_V, path='../results/GSE93028/sleuth/results_sleuth_W_x_V_Chen_et.al.xlsx')
#write_xlsx(sleuth_results_Q, path='../results/GSE93028/sleuth/results_sleuth_W_x_Q_Chen_et.al.xlsx')
#write_xlsx(sleuth_results_C, path='../results/GSE93028/sleuth/results_sleuth_W_x_C_Chen_et.al.xlsx')
#write_xlsx(sleuth_results_R, path='../results/GSE93028/sleuth/results_sleuth_W_x_R_Chen_et.al.xlsx')
...
ggtitle("lncov1") + theme_bw(10) + 
  theme(legend.position="none", plot.title = element_text(size = 16, face="italic")) +
  ylab(expression("Estimated counts")) + xlab("Samples") + 
...
```{r, fig.height=5, fig.width=10}
plot2 <- plot_bootstrap(so, "XM_006569892.2", units = "est_counts", color_by = "condition") +

ggtitle("Ef1α") + theme_bw(10) + 
  theme(legend.position="none", plot.title = element_text(size = 16, face="italic")) +
  ylab(expression("Estimated counts")) + xlab("Samples") + 
  facet_rep_wrap(~condition, labeller = as_labeller(names_facet), scales='free_x', 
                 repeat.tick.labels = "All", strip.position="bottom", ncol = 5) + 
...
ggsave(file="../results/GSE93028/figures/boxplot_GSE93028_lncov1_elf1a.jpeg", height=8, width=10, dpi=600)
```
